...
public class ViniciarVenta extends JFrame {
    ...
    private JPanel crearSeccionCentral() {
        ...
        for(int i=0; i<10; i++) {
            agregarPiezaALista("Intel i5 - 1102", "Intel", "$2,000");
        }
    ...
    class CardPieza extends PanelRedondeado {
        public CardPieza(String nombre, String marca, String precio) {
            ...
            // Fijamos dimensiones para que no se estiren al infinito
            ...
            info.add(ico); info.add(new JLabel(desc));

            JPanel precioBtn = new JPanel(new FlowLayout(FlowLayout.RIGHT, 15, 15));
            precioBtn.setOpaque(false);
            JLabel lblP = new JLabel(precio); lblP.setForeground(new Color(50, 255, 100));
            lblP.setFont(new Font("Segoe UI", Font.BOLD, 22));
            JButton btnI = new JButton("Mostrar Info"); btnI.setBackground(new Color(50, 255, 100));
            precioBtn.add(lblP); precioBtn.add(btnI);
